...
class Settings(BaseSettings):
    ...
    openai_model: str = "gpt-5.4"  # OpenAI's frontier model (1M context, best quality). Override via OPENAI_MODEL env var.
    ...
    # ~6K tokens in + ~3K tokens out per page ≈ $0.10/page
